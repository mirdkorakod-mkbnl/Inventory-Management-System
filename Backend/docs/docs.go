...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/products/import/preview": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Preview result with total and preview rows",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        ...
        "models.User": {
            ...
            "properties": {
                "email": {
                    "description": "gorm:\"unique\" ห้ามอีเมลซ้ำ",
                    "type": "string"
                },
                "id": {
                    "type": "integer"
                ...
                "role": {
                    "description": "เพิ่ม Role: default เป็น 'user'",
                    "type": "string"
                }
            }
        }
